...
const char *msgs[] = { "0. Quit", "1. Add", "2. Find", "3. Delete", "4. Show", "5. Max", "6. Direct", "7. Show tree" };
...
int (*fptr[])(Node **) = {NULL, d_add, d_find, d_delete, d_show, d_max, d_direct_show, d_showtree};
